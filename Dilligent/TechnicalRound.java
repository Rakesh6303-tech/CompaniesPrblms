<-------------Dilligent Hiring Pattern------------------>
  1)Resume Shortlisting
  2)Aptitude Offline
  3)Techincal Round Offline
------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------: Queries On TechStack :----------------------------------------------------------------------------------
  1) Explain about Oops?
  2) Explain about Normalization? Do Normalization to Example?
  3) 1nf,2NF, 3NF?
  4) Difference Between Encapsulation & Abstraction?
  5) Explain Indexes ? Examples?
  6) RESTAPI?
...
➡️ If the old data was
{"name": "Rakesh", "email": "old@gmail.com"}
it becomes
{"name": "Ron", "email": "ron@gmail.com"}

If you skip a field, it may become null.
